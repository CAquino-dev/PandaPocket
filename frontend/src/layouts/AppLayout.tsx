      ...
      <SidebarInset className="flex flex-col bg-background">
        ...
        <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-border bg-background px-6">
          ...
          <div className="flex items-center gap-4">
            <SidebarTrigger className="text-muted-foreground hover:bg-money/10 hover:text-money dark:hover:bg-primary/20 dark:hover:text-primary-light transition-all duration-200 rounded-md p-2" />
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-money dark:bg-primary-light animate-pulse" />
            </Button>

            {/* Dark Mode Toggle */}
            <div
              className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-border 
                            bg-money/10 dark:bg-primary/20 transition-colors"
            >
              <SunIcon
                className={cn(
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="flex items-center gap-3 px-2 rounded-full
                hover:bg-money/10 
                hover:text-money
                dark:hover:bg-primary/20 
                dark:hover:text-primary-light
                ...
                >
                  <Avatar className="h-8 w-8 border-2 border-money/20 dark:border-primary-light/20">
                    <AvatarFallback className="bg-money/10 text-money dark:bg-primary/20 dark:text-primary-light text-xs font-medium">
                      {getUserInitials()}
                    </AvatarFallback>
                  </Avatar>
              ...
              >
                ...
                {/* Profile - Using money colors (same as active sidebar) */}
                <DropdownMenuItem
                ...
                dark:focus:text-primary-light"
                >
                  <UserIcon className="h-4 w-4" />
                  <span className="text-sm">Profile</span>
                </DropdownMenuItem>

                {/* Settings - Using money colors (same as active sidebar) */}
                <DropdownMenuItem
                ...
                {/* Logout - Using expense colors (red) */}
                <DropdownMenuItem
                  onClick={logout}
                  className="flex items-center gap-2 cursor-pointer
                transition-all duration-200
                ...
                hover:bg-expense/10 
                hover:text-expense-dark
                dark:hover:bg-expense/20 
                dark:hover:text-expense-light
                focus:bg-expense/10 
                focus:text-expense-dark
                dark:focus:bg-expense/20 
                dark:focus:text-expense-light"
                >
